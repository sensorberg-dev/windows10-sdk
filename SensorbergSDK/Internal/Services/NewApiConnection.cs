...
namespace SensorbergSDK.Internal.Services
{
    ...
    /// </summary>
    public class NewApiConnection : IApiConnection
    {
        private static readonly ILogger Logger = LogManagerFactory.DefaultLogManager.GetLogger<NewApiConnection>();
        ...
        public async Task<ResponseMessage> RetrieveLayoutResponse(string apiId)
        {
            ...
            requestMessage.RequestUri = new Uri(Configuration.GetLayoutUriV2(apiId));
...
//            apiConnection.DefaultRequestHeaders.Add(Constants.XApiKey, string.IsNullOrEmpty(apiId) ? Configuration.ApiKey : apiId);
        ...
        public async Task<string> LoadSettings()
        {
            try
            {
                ...
                requestMessage.Method = HttpMethod.Get;
                requestMessage.RequestUri = new Uri(Configuration.GetSettingsUriV2());
...
//                apiConnection.DefaultRequestHeaders.Add(Constants.XApiKey, Configuration.ApiKey);
                ...
                System.Net.Http.HttpResponseMessage responseMessage = await apiConnection.PostAsync(new Uri(Configuration.GetPushHistoryV2()), content);
